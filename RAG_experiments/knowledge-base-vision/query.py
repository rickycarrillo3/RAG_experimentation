"""
query.py - CLI chat interface for the vision-extracted knowledge base.
...
- Mathematical equations in the context are in LaTeX notation.
...
def main():
    print("Loading knowledge base (vision-extracted)...")
